...
function CreateRoom() {
    ...
    return (
        <div className="bg-white border d-flex justify-content-between mt-3 p-3 position-relative rounded shadow">
            ...
            {/* Slider */}
            <div>
                <img className="rounded-circle me-2" src="https://source.unsplash.com/random/1" alt="avatar"
            ...
            <div className="d-none d-xxl-block position-absolute start-0 top-50 translate-middle" type="button"
                ...
                <div className="align-items-center bg-white border d-flex justify-content-center p-2 pointer rounded-circle story"
